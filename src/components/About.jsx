        ...
        <section id='about' className="pt-24">
            ...
            <div className="flex justify-center">
                ...
                <p className='text-ingress md:max-w-[60vw] mb-16'> Curiosity reduced Paul's fear to a manageable level.
                    ...
                    trapped by that hand at his neck: the gom jabbar. The Baron wished he could be back in the
                    industrialized warmth and civilized complexity of
                    Giedi Prime, the central world of House Harkonnen.
